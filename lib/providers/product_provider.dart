...
class ProductProvider with ChangeNotifier{
  ...
  List <ProductModel> products = [
    ProductModel(
      ...
      productTitle: "Apple iPhone 14 Pro (128GB) - Uzay Siyahı",
    ...
    ProductModel(
      //2
      productId: 'iphone13-256-deepBlack',
      productTitle: "Apple İphone 13 (256GB) - Gece Syahı",
    ...
    ProductModel(
      //3
      productId: 'iphone14-256-blue',
      productTitle: "Apple İphone 14 (128GB) - Mavi",
    ...
    ProductModel(
      ...
      productTitle: "Samsung Galaxy S22 Ultra (256GB) - Hayalet Siyahı",
      productPrice: "4199.99",
    ...
    ProductModel(
      //8
      productId: 'samsung-galaxy-zFilp',
      productTitle: "Samsung Galaxy Z Flip3 5G (256GB) - Krem",
      productPrice: "3249.99",
    ...
    ProductModel(
      //9
      productId: 'iphone-14',
      productTitle: "Apple İphone 14 Plus (512GB) - Mavi",
